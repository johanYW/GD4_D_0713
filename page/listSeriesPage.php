...
0.19);" >
    ...
    <div class="btn-toolbar justify-content-between">
        ...
        <div class="body d-flex justify-content-between">
            <a href="../page/createSeriesPage.php">
                <button type="submit" class="btn btn-primary" name="create">Create</button></a>
    ...
    if (mysqli_num_rows($query) == 0) {
        ...
        onClick="return confirm"> <i style="color: red" class="fa-solid fa-gears fa-2x"></i>
        </a>
        </td>
        <td>
